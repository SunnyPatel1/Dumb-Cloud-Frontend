...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppSoftwareSoftwareComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _software_software_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    ...
    var routes = [{
      ...
      path: 'software',
      component: _software_software_component__WEBPACK_IMPORTED_MODULE_4__["SoftwareComponent"]
    }];
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _software_software_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./software/software.component */
    "./src/app/software/software.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_6__["AppComponent"], _users_users_component__WEBPACK_IMPORTED_MODULE_7__["UsersComponent"], _software_software_component__WEBPACK_IMPORTED_MODULE_9__["SoftwareComponent"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_5__["AppRoutingModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_8__["BrowserAnimationsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"]],
      providers: [],
  ...
  /***/
  function srcAppDataRetrieveServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "DataRetrieveService", function () {
    ...
    var DataRetrieveService =
    /*#__PURE__*/
    function () {
      function DataRetrieveService(http) {
        _classCallCheck(this, DataRetrieveService);

        this.http = http;
      }

      _createClass(DataRetrieveService, [{
        key: "getUsers",
        ...
        key: "getUsersBySoftware",
        value: function getUsersBySoftware(id) {
          return this.http.get('http://ec2-18-225-5-90.us-east-2.compute.amazonaws.com:3000/api/licenses/bysoftware/' + id);
        }
      }, {
        key: "getSoftwareByUser",
        value: function getSoftwareByUser(id) {
          return this.http.get('http://ec2-18-225-5-90.us-east-2.compute.amazonaws.com:3000/api/licenses/byuser/' + id);
        }
      }, {
        key: "addLicense",
        value: function addLicense(json) {
          return this.http.post('http://ec2-18-225-5-90.us-east-2.compute.amazonaws.com:3000/api/licenses/', json);
        }
      }, {
        key: "addUser",
        value: function addUser(json) {
          return this.http.post('http://ec2-18-225-5-90.us-east-2.compute.amazonaws.com:3000/api/people', json);
        }
      }, {
        key: "deleteUser",
        value: function deleteUser(json) {
          return this.http.request('delete', 'http://ec2-18-225-5-90.us-east-2.compute.amazonaws.com:3000/api/people', {
            body: json
          });
        }
      }, {
        key: "deleteLicense",
        value: function deleteLicense(json) {
          return this.http.request('delete', 'http://ec2-18-225-5-90.us-east-2.compute.amazonaws.com:3000/api/licenses/', {
            body: json
          });
        }
      }, {
        key: "addSoftware",
        value: function addSoftware(json) {
    ...
    DataRetrieveService.ctorParameters = function () {
      return [{
        type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]
      }];
    };

    DataRetrieveService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    })], DataRetrieveService);
    /***/
  },
  ...
  function srcAppDataServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _data_retrieve_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    /*#__PURE__*/
    function () {
      function DataService(dataGetter) {
      ...
      _createClass(DataService, [{
        ...
        value: function getUsers() {
          ...
          this.dataGetter.getUsers().subscribe(function (data) {
            _this.users = data;
            console.log(_this.users);

            _this.gotUsers.emit("done");
          });
        }
      }, {
        key: "getSoftware",
        value: function getSoftware() {
          ...
          this.dataGetter.getSoftware().subscribe(function (data) {
            _this2.software = data;
            console.log(_this2.software);

            _this2.gotSoftware.emit("done");
          });
        }
      }, {
        key: "getSoftwareByUsers",
        value: function getSoftwareByUsers(id) {
          var _this3 = this;

          this.dataGetter.getSoftwareByUser(id).subscribe(function (data) {
            _this3.softwareForUser = data;
            console.log(_this3.softwareForUser);

            _this3.gotSoftwareByUser.emit("done");
          });
        }
      }, {
        key: "getUsersBySoftware",
        value: function getUsersBySoftware(id) {
          ...
          this.dataGetter.getUsersBySoftware(id).subscribe(function (data) {
            _this4.usersForSoftware = data;
            console.log(_this4.usersForSoftware);

            _this4.gotUsersBySoftware.emit("done");
          });
        }
      }, {
        key: "addLicenseToUser",
        value: function addLicenseToUser(json, id) {
          var _this5 = this;

          this.dataGetter.addLicense(json).subscribe(function (data) {
            _this5.getSoftwareByUsers(json.u_id);
          });
        }
      }, {
        key: "addLicenseToSoftware",
        value: function addLicenseToSoftware(json, id) {
          var _this6 = this;

          this.dataGetter.addLicense(json).subscribe(function (data) {
            _this6.getUsersBySoftware(json.s_id);
          });
        }
      }, {
        key: "addUser",
        value: function addUser(json) {
          ...
          this.dataGetter.addUser(json).subscribe(function (data) {
            _this7.getUsers();
          });
        }
      }, {
        ...
        value: function deleteUser(json) {
          ...
          console.log(json);
          this.dataGetter.deleteUser(json).subscribe(function (data) {
            _this8.getUsers();
          });
        }
      }, {
        key: "deleteLicenseForUser",
        value: function deleteLicenseForUser(json) {
          var _this9 = this;

          this.dataGetter.deleteLicense(json).subscribe(function (data) {
            _this9.getSoftwareByUsers(json.u_id);
          });
        }
      }, {
        key: "addSoftware",
        value: function addSoftware(json) {
          ...
          this.dataGetter.addSoftware(json).subscribe(function (data) {
            _this10.getSoftware();
          });
        }
      }, {
        key: "deleteLicenseForSoftware",
        value: function deleteLicenseForSoftware(json) {
          var _this11 = this;

          this.dataGetter.deleteLicense(json).subscribe(function (data) {
            _this11.getUsersBySoftware(json.s_id);
          });
        }
      }]);
  ...
  /***/
  function srcAppSoftwareSoftwareComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppSoftwareSoftwareComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function () {
      function SoftwareComponent(data) {
        ...
        this.data.gotSoftware.subscribe(function (c) {
          return _this12.software = _this12.data.software;
        });
        this.data.getUsers();
        this.data.gotUsers.subscribe(function (c) {
          return _this12.users = _this12.data.users;
        });
      }
      ...
      _createClass(SoftwareComponent, [{
        ...
        key: "onManage",
        value: function onManage(id, name) {
          var _this13 = this;
          ...
          this.data.gotUsersBySoftware.subscribe(function (c) {
            return _this13.usersForCurrentSoftware = _this13.data.usersForSoftware;
          });
        }
      }, {
        key: "onAddSoftware",
        value: function onAddSoftware() {
          console.log('hai');
          var json = {
            "name": this.addSoftwareForm.get('name').value
          };
          this.data.addSoftware(json);
        }
      }, {
        key: "onRevoke",
        value: function onRevoke(id) {
          var json = {
            "u_id": id,
            "s_id": this.current.id
          };
    ...
    SoftwareComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-software',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./software.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/software/software.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./software.component.css */
      "./src/app/software/software.component.css")).default]
    })], SoftwareComponent);
    /***/
  },
  ...
  function srcAppUsersUsersComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function UsersComponent(data) {
        ...
        this.data.getUsers();
        this.data.gotUsers.subscribe(function (c) {
          return _this14.users = _this14.data.users;
        });
        this.data.getSoftware();
        this.data.gotSoftware.subscribe(function (c) {
          return _this14.software = _this14.data.software;
        });
      ...
      _createClass(UsersComponent, [{
        ...
        key: "onManage",
        value: function onManage(name, id) {
          var _this15 = this;
          ...
          this.data.gotSoftwareByUser.subscribe(function (c) {
            return _this15.softwareForCurrentUser = _this15.data.softwareForUser;
          });
        }
      }, {
        key: "onAddKey",
        value: function onAddKey() {
          var json = {
            "s_id": this.newLicenseForm.get('softid').value,
        ...
        value: function onAddUser() {
          var json = this.newUserForm.value;
        ...
        key: "onDeleteLicense",
        value: function onDeleteLicense(id) {
          var json = {
            "s_id": id,
            "u_id": this.currentUser.id
          };
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\sunny\Desktop\license-app\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
